<?php
/**
 * Widget template (immonex User-defined Properties) for the Estate Pro theme.
 */
?>
<div class="immonex-widget immonex-widget-estate-pro<?php if ( isset( $instance['class'] ) && $instance['class'] ) echo ' ' . $instance['class']; ?>">
	<?php if ( ! empty( $title ) ) { ?>
