<?php
/**
 * Widget template (immonex Property Attachments) for the Houzez theme.
 */
?>
<div class="immonex-widget immonex-widget-houzez widget-inner<?php if ( isset( $instance['class'] ) && $instance['class'] ) echo ' ' . $instance['class']; ?>">
	<?php if ( ! empty( $title ) ) { ?>
	...
	?>
		<li>
			<div class="file-wrap file-wrap-<?php echo $instance['icon_size']; ?> pull-left">
				<?php if ( $att_icon ) { ?>
				...
				<?php } ?>
				<div class="filename"><?php echo esc_html( $att_title ); ?></div>
			</div>

			<div class="pull-right">
				<a href="<?php echo esc_attr( $att_url ); ?>"<?php echo $target; ?>>Download</a>
			</div>
		</li>
	<?php
		endforeach;
