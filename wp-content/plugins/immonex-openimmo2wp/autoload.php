...
/**
 * Base and library classes (immonex WP Free Plugin Core and Licensing) have
 * their own autoloaders.
 */
require_once __DIR__ . '/vendor/immonex/wp-free-plugin-core/src/autoload.php';
require_once __DIR__ . '/vendor/immonex/wp-plugin-licensing/src/autoload.php';
